...
from app.api.v1.endpoints import dataset_version, governance, autonomous_platform, enterprise_platform, auth, dataset_mgmt, inference_api, export_api
...
api_router.include_router(auth.router, prefix="/auth", tags=["Enterprise Auth & RBAC"])
